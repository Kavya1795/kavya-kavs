...
<nav class="navbar navbar-inverse">
  <div class="container-fluid">
    <div class="navbar-header">
      ...
      <!-- <a class="navbar-brand" href="/shopmusic/"><span class="glyphicon glyphicon-home"></span></a> -->
    </div>
    <div class="collapse navbar-collapse" id="myNavbar">
      <ul class="nav navbar-nav">
        <li ><a href="/shopmusic/">Home</a></li>
        <li ><a href="/shopmusic/customerSignUp">Sign Up</a></li>
		  <li>&nbsp; &nbsp; &nbsp; &nbsp;</li>
		    <li>&nbsp; &nbsp; &nbsp; &nbsp;</li>
...
<div>
<center><img src="resources/images/21.jpg" style="width: 400px"; height="300px"></center>
<hr></hr>  
...
<!--  <div class="container">
  <center><h2 style="color: black;">Shopmusic</h2></center>
  <div>
